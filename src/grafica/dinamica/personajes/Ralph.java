...
public class Ralph extends GGO {
	private BufferedImage hitOnWay1, hitOnWay2, leftHitFly, rightHitFly, standing, leftHit, rightHit, leftHitM, rightHitM,rightWalkingA, rightWalkingB, leftSadWalking;
	...
	private void uploadImages () {
		try {
			...
			if (leftSadWalking == null) {
				leftSadWalking = this.up("u_leftWalking_sad.png");
			}
			if (leftHit == null) {
